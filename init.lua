...
minetest.register_on_joinplayer(function(ObjectRef)
    minetest.chat_send_player(ObjectRef:get_player_name(), "Froager 2 - by Zander")
...
local modules = {"items", "crafts", "ovencrafts", "weapons", "tools", "blocks", "ores", "biomes", "forge", "hammer", "essence_crafts", "wands"}
